...
export type GetMoodsQueryQuery = {
  __typename?: "Query";
  getMoods?: Array<{
    __typename?: "MoodEntry";
    date: string;
...
export type PostMoodMutationMutation = {
  __typename?: "Mutation";
  postMood?: {
    __typename?: "PostMoodReturn";
    mood: number;
...
export type PostUserMutationMutation = {
  __typename?: "Mutation";
  postUser?: string | null;
};

export const GetMoodsQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMoodsQuery" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getMoods" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "date" } },
                { kind: "Field", name: { kind: "Name", value: "entry_id" } },
...
} as unknown as DocumentNode<GetMoodsQueryQuery, GetMoodsQueryQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "LoginQuery" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<LoginQueryQuery, LoginQueryQueryVariables>;
export const PostMoodMutationDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "PostMoodMutation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "mood" } },
          type: {
            kind: "NonNullType",
  ...
  PostMoodMutationMutation,
  PostMoodMutationMutationVariables
>;
export const PostUserMutationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "PostUserMutation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  PostUserMutationMutation,
  PostUserMutationMutationVariables
>;
